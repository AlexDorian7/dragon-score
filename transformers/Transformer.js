...
const ret = {
  ...
  lessons: [
    {
      id: "propositional_translations_easy",
      name: "Propositional Translations Easy",
    ...
    {
          id: "propositional_translations_hard",
          name: "Propositional Translations Hard",
          description: "PLEASE CHANGE ME",
          randomize: true,
          questionGenerators: [],
          staticQuestions: []
...
set.subSets[0].questions.forEach(question => {
  let ret1 = {
...
set.subSets[1].questions.forEach(question => {
  let ret1 = {
    question: question.prompt,
    answers: []
  };
