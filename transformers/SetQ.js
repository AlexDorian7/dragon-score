...
const ret = {
  ...
  lessons: [
    {
      id: "lesson_definitions",
      name: "Definitions",
      description: "Set Q deals with common errors about definitions.It goes with the \"Meaning and Definitions\" chapter of Harry J.Gensler's Introduction to Logic (Routledge Press).\nAssume that these definitions try to explain current usage and don't stipulate how a term will be used.",
      questionGenerators: [],
      staticQuestions: []
    }
  ],
...
setQ.subSets[0].questions.forEach(question => {
  let ret1 = {
  ...
  question.options.forEach(answer => {
    let ret2 = {
      answer: answer.label,
      correct: question.correctId.find((num) => num === answer.id) !== undefined
    };
    ret1.answers.push(ret2);
  });
